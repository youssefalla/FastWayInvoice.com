      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-zinc-300 leading-relaxed">
          <section>
            ...
            <p>Welcome to FastWay Invoice. We respect your privacy and are committed to protecting it through our compliance with this policy. This Privacy Policy outlines our practices regarding the information we collect and how we use it.</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4 text-zinc-100">1. Data Storage and Processing</h2>
            <p>FastWay Invoice is designed as a "local-first" or "offline-first" application. This means that <strong>we do not store your financial data, client information, or generated invoices on our servers.</strong></p>
          ...
          <section>
            ...
            <p>To keep FastWay Invoice free for all users, we use Google AdSense to display advertisements on our website.</p>
            <ul className="list-disc pl-6 mt-4 space-y-2">
