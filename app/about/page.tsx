  ...
  return (
    <div className="min-h-screen bg-[#0e0d14] text-white py-20 px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="text-4xl font-bold mb-8" style={{ fontFamily: 'var(--font-poppins)' }}>About FastWay Invoice</h1>
        ...
        <div className="space-y-12 text-zinc-300 leading-relaxed">
          ...
          <section>
            ...
            <p>
              I wanted a tool that would allow me to generate a beautiful, professional invoice instantly—no signup, no friction, and no tracking. That’s why I built FastWay Invoice.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="p-6 rounded-2xl border border-white/5 bg-[#16161e]">
                ...
                <p className="text-sm text-zinc-400">We don't believe in paywalling basic business administrative tools. FastWay Invoice will remain free to use forever.</p>
              </div>
            </div>
          </section>
          ...
          <section className="mt-12 pt-12 border-t border-white/5">
            ...
            <p className="mb-6">
              I'm actively working to make FastWay Invoice the best (and fastest) free invoice generator on the internet. Your feedback is what drives the next set of features.
            </p>
