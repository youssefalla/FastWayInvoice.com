      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-zinc-300 leading-relaxed">
          <section>
            ...
            <p>Welcome to FastWay Invoice. By accessing or using our website, you agree to be bound by these Terms of Service. If you disagree with any part of the terms, then you may not access the service.</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4 text-zinc-100">1. Use of the Service</h2>
            <p className="mb-4">FastWay Invoice provides a free, offline-first tool to generate PDF invoices. You agree to use the Service only for lawful purposes.</p>
          </section>
          ...
          <section>
            ...
            <p>FastWay Invoice serves strictly as a formatting and generation tool. We do not verify the legal validity, mathematical accuracy, or tax compliance of the documents you create. It is your responsibility to ensure that the invoices meet the legal and financial requirements of your jurisdiction.</p>
          </section>
          ...
          <section>
            ...
            <p>The Service is provided on an "AS IS" and "AS AVAILABLE" basis. FastWay Invoice makes no representations or warranties of any kind, express or implied, as to the operation of the service, or the information, content, or materials included.</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4 text-zinc-100">6. Limitation of Liability</h2>
            <p>In no event shall FastWay Invoice, nor its directors, employees, partners, agents, suppliers, or affiliates, be liable for any indirect, incidental, special, consequential or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your access to or use of or inability to access or use the Service.</p>
          </section>
        </div>
      </div>
    </div>
