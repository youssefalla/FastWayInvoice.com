      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-zinc-300 leading-relaxed">
          <section>
            ...
            <p>This Cookie Policy explains how FastWay Invoice uses cookies and similar technologies to recognize you when you visit our website. It explains what these technologies are and why we use them, as well as your rights to control our use of them.</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-4 text-zinc-100">1. Local Storage (Not Cookies)</h2>
            <p className="mb-4">It is important to understand that FastWay Invoice relies primarily on your browser's <strong>Local Storage</strong>, not cookies, to function. When you add a client, update your company details, or create an invoice, that data is saved locally on your device using Local Storage. This allows the application to remain fast, offline-capable, and entirely private.</p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">We use cookies primarily for advertising purposes. Because FastWay Invoice is entirely free, we rely on Google AdSense to monetize the platform.</p>
